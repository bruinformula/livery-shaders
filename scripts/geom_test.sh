...
./build/bin/StepConvertUsd --inputStepFile $MK11_ROOT/car/step_files/MK11-TOP-001-A-TOP_ASSEMBLY.STP --outputFile ./build/Mk11-1.usdc
./build/bin/StepConvertUsd --inputStepFile $MK11_ROOT/car/step_files/MK11-TOP-002-A-TOP_ASSEMBLY.STP --outputFile ./build/Mk11-2.usdc